...
//   useEffect(() => {
//     fetch("https://backend-doancoso.onrender.com/stores/api")
...
//         </div>
//         <div
//           className="p-4 bg-white shadow-lg overflow-y-auto w-1/3"
//           style={{ height: "400px" }}
//         >
...
//                 <p>
//                   Address: <span className="fw-bold">{store.address}</span>
//                 </p>
//                 <p>
//                   Open at :{" "}
//                   <span className="fw-bold">{store.openingHours}</span>
//                 </p>
//                 <p>
//                   Close at :{" "}
//                   <span className="fw-bold">{store.closingHours}</span>
//                 </p>
//                 <button
...
const StoreLocator = () => {
  ...
  useEffect(() => {
    fetch(`${API}/stores/api`, { credentials: "include" })
      .then((response) => response.json())
      .then((data) => {
        setStores(data);
        setFilteredStores(data);
