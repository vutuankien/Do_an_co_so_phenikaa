...
//   const blogAPI = `https://backend-doancoso.onrender.com/blog/api/${id}`;
...
//         <span>
//           {" "}
//           • Posted on <span>{blog.createdAt}</span>
//         </span>
//         <span>
//           {" "}
//           •{" "}
//           <span className="text-pink-500 font-medium">{blog.views} views</span>
//         </span>
//       </div>
//       <div className="mt-4">
//         <img
...
const BlogDetails = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto bg-white shadow-md rounded-lg p-6 mt-16">
      ...
      <div className="mt-4">
        <img
          src={blog.image?.[0] || "/default-image.jpg"}
          alt="Blog Cover"
          className="w-full h-80 object-cover rounded-md"
        />
      </div>
