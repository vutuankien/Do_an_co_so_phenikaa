...
//           `https://backend-doancoso.onrender.com/address/api/${uid}`
//         );
...
//     const fetchCart = () => {
//       fetch(`https://backend-doancoso.onrender.com/cart/api/${uid}`)
...
//     fetch(`https://backend-doancoso.onrender.com/customer/api/user?id=${uid}`)
//       .then((response) => response.json())
//       .then((data) => {
...
//     fetch(`https://backend-doancoso.onrender.com/cart/api/update`, {
//       method: "PATCH",
...
//     fetch(
//       `https://backend-doancoso.onrender.com/cart/api/delete/${uid}/${productId}`,
//       {
//         method: "DELETE",
//       }
//     )
...
const Cart = () => {
  ...
  useEffect(() => {
    const fetchAddresses = async () => {
      try {
        const response = await fetch(`${API}/address/api/${uid}`, {
          credentials: "include",
        });
        const data = await response.json();
  ...
  useEffect(() => {
    ...
    const fetchCart = () => {
      fetch(`${API}/cart/api/${uid}`, { credentials: "include" })
        .then((response) => response.json())
        .then((data) => setCartItems(data))
        .catch((error) => console.error("Lỗi khi lấy giỏ hàng:", error));
    };
  ...
  useEffect(() => {
    ...
    fetch(`${API}/customer/api/user?id=${uid}`, { credentials: "include" })
      .then((response) => response.json())
      .then((data) => {
        setUser(data);
      })
  ...
  const deleteCartItem = (productId) => {
    ...
    fetch(`${API}/cart/api/delete/${uid}/${productId}`, {
      method: "DELETE",
      credentials: "include",
    })
      .then((res) => {
